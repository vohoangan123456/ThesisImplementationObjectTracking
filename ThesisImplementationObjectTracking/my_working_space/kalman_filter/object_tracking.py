...
from my_working_space.kalman_filter.yolo_detector import yolo_detector, detection_write, detection_read
...
def multi_tracking_object_write(videopath1, videopath2, options):
    ...
    cam2 = cv2.VideoCapture(videopath2)
    # Create Object Detector
    yolo_detectors1 = detection_write(tfNet, 1, rd_number)
    yolo_detectors2 = detection_write(tfNet, 2, rd_number)
...
def multi_tracking_object_read(videopath1, videopath2, filedetector1, filedetector2, options):
    ...
    # Create Object Detector
    yolo_detectors1 = detection_read(filedetector1)
